...
if (supportsETH(wallet)) {
  let addressNList =
    bip32ToAddressNList(`m/44'/60'/0'/0/0`)
  let msg = { coin: 'Ethereum', addressNList }
  address = await wallet.ethGetAddress(msg)
...
<iframe
  src="https://codesandbox.io/embed/github/keepkeyjon/teach-hdwallet/tree/master/exercises/02-show-address?autoresize=1&expanddevtools=1&fontsize=10&module=%2Fsrc%2FWallet.tsx"
  title="Show Address"
  allow="usb"
  style="width:100%; height:850px; border:0; border-radius: 4px; overflow:hidden;"
  sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin">
